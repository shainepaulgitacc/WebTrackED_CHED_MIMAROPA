...
namespace WebTrackED_CHED_MIMAROPA.Areas.Identity.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<AppIdentityUser> userManager, IBaseRepository<Settings> settingsRepo)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user == null)
            {
                ...
                TempData["validation-message"] = "Failed to reset the password";
